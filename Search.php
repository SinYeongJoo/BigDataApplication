...
starRating();
  ...
  <body>
    ...
    <div class = "cafe_detail_div">
      ...
      <span class="input">
    <input type="radio" name='star_value' id="p1" value="1"/><label for="p1">1</label>
    <input type="radio" name='star_value' id="p2" value="2"/><label for="p2">2</label>
    <input type="radio" name='star_value' id="p3" value="3"/><label for="p3">3</label>
    <input type="radio" name='star_value' id="p4" value="4"/><label for="p4">4</label>
